...
async function color () {
    forEachTimeout(colors, (color) => {
        client.guilds.forEach((guild) => {
                ...
                let role = guild.roles.find('name', 'test');
